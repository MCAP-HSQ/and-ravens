    ...
    return (
        <PageHeader>
            <Flex align='center'>
                ...
                <Flex gap='3' align='center' className='group animate-fadein pr-4'>
                    <Flex gap='1' align={'center'}>
                        <ChannelIcon type={channelData.type} size={16} className='text-gray-10' />
                        <Heading
                            size={{
                                initial: '4',
                                sm: '4'
                            ...
                            weight='medium'
                            className='line-clamp-1 text-ellipsis'>{channelData.channel_name}</Heading>
                    </Flex>
